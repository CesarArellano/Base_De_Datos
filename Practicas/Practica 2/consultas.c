...
{
	int i;
	char Letra, *buffer = "SELECT idAsesor, nombreAsesor, aPaternoAsesor, aMaternoAsesor FROM HistorialAtencion LEFT JOIN Asesores USING(idAsesor) WHERE estado = 'Cerrado' GROUP BY idAsesor";
	MYSQL_RES *res;
	MYSQL_ROW row;	
